...
//        vmProductDepositoryViewModel.stockDepositoryDatas.observe(viewLifecycleOwner) { it ->
//            val filterStockDepositoryList = mutableListOf<StockDepository>()
//            dbStockDepositoryList.filter { it.holdingAmount != 0 }.forEach {
...
//                    }
//
//                    if (dbStockDepositoryList.count() > 0) {
